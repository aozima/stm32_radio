...
#define WEBS_KEEP_TIMEOUT	3000		/* Keep-alive timeout (3 secs) */
#define WEBS_TIMEOUT		6000		/* General request timeout (6 secs) */
 ...
 */
#ifdef EMF
extern int 		 websEmfOpen(void);
extern void 	 websEmfClose(void);
