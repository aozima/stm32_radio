...
#ifdef LITTLEFOOT
#define WEBS_HEADER_BUFINC 		250			/* Header buffer size */
#define WEBS_ASP_BUFINC			250			/* Asp expansion increment */
#define WEBS_MAX_PASS			32			/* Size of password */
#define WEBS_BUFSIZE			512			/* websWrite max output string */
#define WEBS_MAX_HEADER			(2 * 1024)	/* Sanity check header */
