...
rt_size_t lcd_fmt_read(rt_device_t dev, rt_off_t pos, void* buffer, rt_size_t size)
{
	int x, y;
	rt_uint16_t* ptr;
	rt_uint32_t index;
...
rt_size_t lcd_fmt_write (rt_device_t dev, rt_off_t pos, const void* buffer, rt_size_t size)
{
	int x, y;
	rt_uint16_t* ptr;
	rt_uint32_t index;
